...
spks = ['p239', 'p259', 'p263'] #p236 임시로 제외
...
if __name__ == "__main__":
    ...
    for spk in spks :
        log_dir = f'log/Codebook_only_train/local/{codebooksize}_{learning_rate}/{spk}'
        ...
        for epoch in range(epochs):
            ...
            for batch in pbar:
                ...
                # 3. Decoder (Frozen, 6-step prediction)
                with torch.no_grad():
            ...
            if avg_val_total < best_val_loss:
                ...
                torch.save(checkpoint, f"{log_dir}/best_model.pt") 
