...
if __name__ == "__main__":
    ...
    for spk in speakers :
        log_dir = f'log/Decoder_only/local/{codebooksize}_diff_{learning_rate}/{spk}'
        ...
        for epoch in range(epochs):
            ...
            for batch in pbar:
                ...
                print(f"Quantizer Training Mode: {quantizer.training}")
                print(f"Codebook Requires Grad: {quantizer.embeddings.weight.requires_grad}")
                # 3. Decoder (Trainable)
