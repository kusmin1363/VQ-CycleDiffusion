...
import random
from model.codebook import VectorQuantizer  # <-- 추가
import datetime
...
log_dir = f'log/All_joint/global/{codebooksize}_diff_{learning_rate}_code_{code_lr}_encoder_{encode_lr}'
...
if __name__ == "__main__":
    ...
    optimizer = torch.optim.Adam([
        ...
        {'params': model.encoder.parameters(), 'lr': float(encode_lr)},
