import os
from inference_vq_mapping_global import inference
...
model_name = f'codebook_decoder_train_{codebooksize}' 
output_dir = f'samples/{model_name}'
quantizer_path = f'log/codebook_stock_255_exclude/global/codebook_stock_{codebooksize}.pt'
    ...
    for src_sentence, tgt_sentence in permutations(unseen_sentences, 2):
        ...
        if not os.path.exists(output_path):
            ...
            if os.path.exists(src_path) and os.path.exists(tgt_path):
                ...
                inference(vc_model_path, quantizer_path, src_path, tgt_path, output_path)
