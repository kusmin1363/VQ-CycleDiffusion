import os
from convert.inference.inference_vq_mapping_without_source_weightedsum import inference
...
output_dir = f'final_samples_fixed/vq_mapping/global_tgt_weightedsum/{model_name}'
