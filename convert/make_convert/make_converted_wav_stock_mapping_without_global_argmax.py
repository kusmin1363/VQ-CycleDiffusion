import os
from convert.inference.inference_vq_mapping_without_global_argmax import inference
...
for codebooksize in [512, 1024, 2048, 4096, 8192]:
    ...
    output_dir = f'final_samples_fixed/vq_mapping/src_tgt_argmax/{model_name}'
